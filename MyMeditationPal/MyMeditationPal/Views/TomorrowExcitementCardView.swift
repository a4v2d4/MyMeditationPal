//
//  TomorrowExcitementCardView.swift
//  MyMeditationPal
//
...
struct TomorrowExcitementCardView: View {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                HStack {
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Excited About Tomorrow?")
                            .font(.system(size: 20, weight: .semibold))
                            .foregroundColor(Theme.textPrimary)
                        
                        Text("Look forward with joy")
                            .font(.system(size: 15))
...
#Preview {
    VStack {
        TomorrowExcitementCardView(isCompleted: false, onTap: {})
            .padding()
        
        TomorrowExcitementCardView(isCompleted: true, onTap: {})
            .padding()
    }
