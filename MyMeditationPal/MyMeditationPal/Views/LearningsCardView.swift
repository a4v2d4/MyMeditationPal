...
#Preview {
    VStack {
        LearningsCardView(isCompleted: false, onTap: {})
            .padding()
        
        LearningsCardView(isCompleted: true, onTap: {})
            .padding()
    }
